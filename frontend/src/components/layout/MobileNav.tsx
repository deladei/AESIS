  ...
  return (
    <>
      <button
        ...
        className="rounded-full p-2 text-[var(--h-464652)] transition-colors hover:bg-[var(--h-dce9ff)] md:hidden"
      ...
      {createPortal(
        ...
        >
          ...
          <div
            ...
            className={cn(
              'absolute inset-0 bg-[var(--h-0b1c30-40)] backdrop-blur-sm transition-opacity duration-300',
          ...
          <div
            ...
            className={cn(
              'absolute inset-y-0 left-0 flex w-[280px] max-w-[85%] flex-col bg-[var(--h-eff4ff)] shadow-2xl transition-transform duration-300 ease-out',
            ...
            <div className="flex items-center justify-between px-5 py-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-semibold text-[var(--h-464652)]">{brandSubtitle}</p>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="rounded-full p-2 text-[var(--h-464652)] transition-colors hover:bg-[var(--h-dce9ff)]"
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ? 'bg-[var(--h-8a4cfc)] font-semibold text-white shadow-sm shadow-[var(--h-8a4cfc-30)]'
