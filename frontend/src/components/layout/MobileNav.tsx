  ...
  return (
    <>
      <button
        ...
        className="rounded-full p-2 text-ink-secondary transition-colors hover:bg-brand-soft md:hidden"
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold leading-tight text-brand-ink">AESIS</h2>
                  <p className="text-[11px] font-semibold text-ink-secondary">{brandSubtitle}</p>
                </div>
              </div>
              <button
                type="button"
            ...
            <div className="border-t border-line p-3">
              <div className="flex items-center gap-3 px-2 py-2">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-ink-secondary">{roleLabel ?? user.email}</p>
                </div>
              </div>
              <button
                type="button"
                onClick={() => onLogout()}
                className="mt-1 flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-ink-secondary transition-colors hover:bg-danger-soft hover:text-danger"
              >
